...
def RBP(generated_samples_interpretable, global_signals, segment_indexes, f):
    ...
    for sample_interpretable in generated_samples_interpretable:
        raw_signal = global_signals.copy()
...
def LIMESegment(example, datasets, model, model_type='class', distance='dtw', n=100, window_size=None, cp=None, f=None):
    ...
    #
    generated_samples_raw = RBP(generated_samples_interpretable, datasets, segment_indexes, f)
    #
